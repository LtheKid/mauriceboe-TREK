const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.importTrip': 'Import JSON',
  'dashboard.importTripJson': 'Import itinerary JSON',
  'dashboard.importTripJsonHint': 'Upload a TREK itinerary JSON file to create a new trip with days, places, schedule, accommodations, and booking details.',
  'dashboard.importJsonDropHere': 'Drop a .json file here or click to choose one',
  'dashboard.importJsonTabFile': 'Upload file',
  'dashboard.importJsonTabPaste': 'Paste JSON',
  'dashboard.importJsonPasteButton': 'Paste from clipboard',
  'dashboard.importJsonPastePlaceholder': 'Paste itinerary JSON here…',
  'dashboard.importJsonPasteEmpty': 'Paste itinerary JSON to import',
  'dashboard.importJsonInvalid': 'The pasted text is not valid JSON',
  'dashboard.importJsonClipboardEmpty': 'Clipboard is empty',
  'dashboard.importJsonClipboardError': 'Could not read from clipboard. Paste manually instead.',
  'dashboard.importJsonSuccess': 'Imported "{title}"',
  'dashboard.importJsonError': 'Failed to import itinerary JSON',
  'dashboard.importJsonUnsupported': 'Please choose a .json file',
  'dashboard.importJsonTooLarge': 'JSON file is too large. Maximum size is {maxMb} MB.',
  ...
  'settings.mapMarkerMode': 'Marker Display Mode',
  'settings.mapMarkerPhotos': 'Photos',
  'settings.mapMarkerPhotosHint': 'Show place photos when available, then fall back to category icons.',
  'settings.mapMarkerCategories': 'Category icons',
  'settings.mapMarkerCategoriesHint': 'Always show category colors and icons for clearer place types.',
  ...
  'dayplan.exportPdf': 'PDF',
  'dayplan.exportIcs': 'ICS Calendar',
  'dayplan.exportJson': 'JSON itinerary',
  'dayplan.exportMarkdown': 'Copy markdown',
  'dayplan.markdownTooltip': 'Copy itinerary as markdown',
  'dayplan.jsonTooltip': 'Download itinerary JSON for import or AI editing',
  'dayplan.pdf': 'PDF',
  ...
  'places.importFileHint': 'Import .gpx, .kml, .kmz, or .json files from tools like Google My Maps, Google Earth, GPS trackers, or AI-generated place lists.',
  'places.importFileDropHere': 'Click to select a file or drag and drop here',
  'places.importFileDropActive': 'Drop file to select',
  'places.importFileUnsupported': 'Unsupported file type. Use .gpx, .kml, .kmz, or .json.',
  ...
  'places.jsonImported': '{count} places imported from JSON',
  ...
  'places.importGoogleRoute': 'Google Route',
  'places.importNaverList': 'Naver List',
  'places.googleListHint': 'Paste a shared Google Maps list link to import all places.',
  'places.googleRouteHint': 'Paste a Google Maps directions URL to import its stops as unplanned places.',
  'places.googleListImported': '{count} places imported from "{list}"',
  'places.googleRouteImported': '{count} route stops imported from "{list}"',
  'places.googleListError': 'Failed to import Google Maps list',
  'places.googleRouteError': 'Failed to import Google Maps route',
  ...
  'planner.jsonExportFailed': 'JSON export failed',
  'planner.markdownCopied': 'Markdown copied',
  'planner.markdownCopyFailed': 'Failed to copy markdown',
  ...
  'undo.importJsonPlaces': 'JSON places import',
  'undo.importGoogleList': 'Google Maps import',
  'undo.importGoogleRoute': 'Google Maps route import',
