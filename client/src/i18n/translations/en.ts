const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dayplan.import': 'Import',
  'dayplan.export': 'Export',
  'dayplan.copyAiPrompt': 'Copy AI prompt',
  'dayplan.copyAiPromptTooltip': 'Copy a prompt to generate a trip itinerary with AI',
  'dayplan.importJson': 'JSON itinerary',
  'dayplan.importJsonTooltip': 'Import a complete trip from JSON format',
  'dayplan.importSuccess': 'Trip imported: {places} places, {days} days, {reservations} reservations',
  'dayplan.promptCopied': 'AI prompt copied to clipboard',
  'dayplan.promptCopyFailed': 'Failed to copy prompt',
